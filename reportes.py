    ...
    if buscar:
        ...
        for col in columnas_busqueda:
            if col in df_filtrado.columns:
                mascara = mascara | df_filtrado[col].astype(str).str.contains(
                    str(buscar), case=False, na=False
                )
...
def reportes(bodega):
    ...
    try:
        ...
        with tab1:
            ...
            ingresos_res = aplicar_filtros_basicos(
                ingresos, fecha_inicio=fecha_inicio, fecha_fin=fecha_fin
            )
            salidas_res = aplicar_filtros_basicos(
                salidas, fecha_inicio=fecha_inicio, fecha_fin=fecha_fin
            )
        ...
        with tab3:
            ...
            if tipo_reporte == "Inventario completo":
                ...
                proyecto = st.selectbox("Proyecto", proyectos, key="proyecto_export")
